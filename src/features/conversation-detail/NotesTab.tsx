...
/**
 * Conversation Detail's Notes tab — where the `<NotesPane>` draft lands
 * permanently once recording ends, rather than vanishing. Always-editable,
 * not click-to-edit like the title —
...
export function NotesTab({
  ...
  return (
    <div className={`${READING_MAX_W} mx-auto py-4`}>
      <textarea
        aria-label="Notes"
